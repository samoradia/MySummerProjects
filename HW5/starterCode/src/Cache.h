...
public:
     ...
     *
     * If the element is present in the cache, you should act as though you'd accessed it so that
     * it is unlikely to be deleted any time soon.
     *
     * This function should run in time O(1).
     *
...
private:
     ...
     */
    struct Node {
        std::string keys; // std::string because this is a header file.
        ValueType   values;
        Node*       prev;
        Node*       next;
    };
