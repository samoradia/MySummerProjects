...
//Extra feature- Allows initial or final word to NOT be found in the dictionary (difference found in function checkInput, lines 108-111)
//Also: note difference in parameters for checkInput and promptUser functions
//Sources:
...
void promptUser(string &word1, string &word2);
bool checkInput(string &word1, string &word2, string &error);
...
void promptUser(string &word1, string &word2){
    ...
    if (word1.empty() || word2.empty()){
        ...
        while (!checkInput(word1, word2, error)){
            cout << error << endl;
            word1 = getLine("Enter word 1");
            word2 = getLine("Enter word 2");
        }
